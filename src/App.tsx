        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>
                Add a new <span className="highlight">subordinates</span> property to each employee,
                it should be an array filled with the employee's subordinates
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                Use of a router to give the user the ability isolate a particular employee chain
              </li>
            </ul>
          </li>
        </ul>
